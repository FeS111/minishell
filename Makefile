...
# File Variables
NAME	= minishell
SRC		= $(addprefix $(VPATH), main.c buildin2.c buildin.c lexer.c lexer_util.c split_utils.c tokens.c util.c lexer_get.c signal_handler.c lexer_get2.c executer.c str_util.c)
